  ...
  <style>
    ...
    * {
    ...
    .hero-section::after {
      ...
      width: 100%;
      height: 100%;
      background: linear-gradient(135deg, rgba(0,0,0,0.65) 0%, rgba(44,62,80,0.45) 100%);
      z-index: 0;
      pointer-events: none;
    }
...
<body>
  ...
  <main>
    <section id="home">
      ...
      <video class="bg-video" autoplay muted loop playsinline poster="hero-image.jpg">
        <source src="video.mp4" type="video/mp4">
        <img src="hero-image.jpg" alt="Static fallback image" style="width:100%;height:100%;object-fit:cover;">
